...
while True: 
    ...
    match instructions_seperated[0]:
        ...
        case 'DISR': #DISR R1
            opcode = "10110"
            itype = "11"
            instruction_binary = itype + opcode + register_location(instructions_seperated[1][1]) + '0'*6
        case 'DISM': #DISM DM1
            opcode = "10111"
            itype = "11"
            instruction_binary = itype + opcode + decimalToBinaryString(instructions_seperated[1][2:4]) + '000'
        case 'DISB': #DISB
            opcode = "11000"
            itype = "11"
            instruction_binary = itype + opcode + '0'*9
        case 'DISP': #DISP
            opcode = "11001"
            itype = "11"
            instruction_binary = itype + opcode + '0'*9
